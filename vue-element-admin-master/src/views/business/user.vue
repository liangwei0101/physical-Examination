  ...
  <div class="app-container">
    ...
    <el-dialog title="增加" :visible.sync="addDialogFormVisible">
      ...
      >
        ...
        <el-form-item label="性别" prop="sex">
          <el-select v-model="addNumberValidateForm.sex" style="width: 100%" placeholder="请选择性别">
        ...
        <el-form-item label="职务" prop="userType">
          <el-select
            v-model="addNumberValidateForm.userType"
            style="width: 100%"
            placeholder="请选择职务"
          >
    ...
    <el-dialog title="修改" :visible.sync="updateDialogFormVisible">
      ...
      >
        ...
        <el-form-item label="性别" prop="sex">
          <el-select v-model="updateNumberValidateForm.sex" style="width: 100%" placeholder="请选择性别">
            <el-option label="男" value="男" />
            <el-option label="女" value="女" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="职务" prop="userType">
          <el-select
            v-model="updateNumberValidateForm.userType"
            style="width: 100%"
            placeholder="请选择职务"
          >
            <el-option label="用户" value="用户" />
